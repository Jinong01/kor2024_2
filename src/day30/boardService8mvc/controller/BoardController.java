...
import day30.boardService8mvc.model.BoardDao;
import day30.boardService8mvc.model.BoardDto;
...
public class BoardController {
    ...
    // 1. 게시물 등록 제어 함수
    public boolean boardWrite(String content, String writer, int pwd) throws SQLException {

        // 1. 다양한 데이터 검사 = 유효성 검사

        // 2. 유효성검사 통과 했으면 서로 다른 데이터를 하나(객체)로 만들기
    ...
    public ArrayList<BoardDto> boardPrint() throws SQLException {
        ...
        // - void 대신 여러개의 게시물 반환받고 싶다.
        // void --> ArrayList<Board>
        // * dao 에게 게시물 전체출력 함수를 호출해서 결과를 받는다.
        // 1. dao 에게 게시물 전체출력 함수를 호출하기 위해 객체 생성
